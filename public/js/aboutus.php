...
<?php include ("include/header.html.twig");?>
    ...
    <div class="row">
      <div class="col-md-12">
        <header class="title-head">
          <h2>About us</h2>
          <p>DOCTOHERE is a solution powered by Novatel IT based in France. Combining a unique diversity of expertise, talents and cultures, our architects design and deliver high Level technology solutions. NOVATEL Group delivers end-to-end Total Innovative IT, Telecommunications and Engineering services to its customer, and business development support in major industries. With over a hundred dedicated professionals and offices already established in France, KSA, Tunisia, Algeria, Libya, Morocco, Jordan, and local partners in West Africa (Senegal, CIV, Mali, Burkina Faso), NOVATEL has become one of the fastest growing ICT solutions providers in the MEA region by delivering innovative approach and project success.</p>
...
<section  id="section5" class="section-5 section-margine">
  <div class="container">
    <div class="row my-team">
      <div class="col-md-12">
        <header class="title-head">
          <h2>Your doctor get closer</h2>
          <p>DOCTOHERE is an electronic health solution for e-consultations.<br>DOCTOHERE removes the need to process paper-based health examination reports, and allows panel doctors to record patient's health information electronically. This includes their health examination results.

As health information is submitted electronically, the information is received instantly by the doctor.</p>
          <div class="line-heading">
            <span class="line-left"></span>
            <span class="line-middle">+</span>
            <span class="line-right"></span>
    ...
    <div class="row">
      <div class="col-md-9 col-lg-9">
        <div class="section-10-box-text-cont">
          <h3>We Are Ready to Check Your Health,<span class="color-yellow">  create you personal account or connect here </span></h3>
        </div>
      </div>
      <div class="col-md-3 col-lg-3">
        <div class="section-10-btn-cont"><a href="#" class="btn btn-secondary wow fadeInUp">Get access</a></div>
      </div>
    </div>
  </div>
</section>
...
<?php include ("include/footer.html.twig");?>